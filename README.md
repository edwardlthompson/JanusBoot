...
![Template](https://img.shields.io/badge/template-1.5.0-0969da?style=flat-square)
...
Current template version: **1.5.0** (see `.template-version`, Release Please, and `scripts/pre-release-gate.sh`).
