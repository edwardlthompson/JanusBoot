...
4. Optional hard isolation: `bash scripts/setup-agent-worktrees.sh` (creates `.cursor/worktrees/`). GC stale copies with `python3 scripts/agent-run.py gc-worktrees` (dry-run; `--apply` after 24h).
