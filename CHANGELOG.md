...
* add coach layer and complete bootstrap defaults ([2f77fb9](https://github.com/edwardlthompson/JanusBoot/commit/2f77fb9a65ad1f1f963e69e276d43972e57b54e5))
* add Continuum-method donations and updates ([53d14bd](https://github.com/edwardlthompson/JanusBoot/commit/53d14bdc824e0330f61473c150cd93cb680930bc))
* add first-run backlog and Windows upgrade-sim gates ([14811be](https://github.com/edwardlthompson/JanusBoot/commit/14811be2f4290841e8bf99bbd002facc50ff8e6e))
* add in-app About screen with format-locked update checker ([29278cc](https://github.com/edwardlthompson/JanusBoot/commit/29278ccad8f1e7ee623e3c761026bbc4711a83a3))
* add industry-standard repo hygiene automation ([136bfe3](https://github.com/edwardlthompson/JanusBoot/commit/136bfe336e3f868c9f32c12e531ea26517765cc2))
* add local-first deps updater and resource packing ([50a3a7f](https://github.com/edwardlthompson/JanusBoot/commit/50a3a7f7b4c1109441084ce5e07987e9fb5805c1))
* add portable first-run tour and multi-agent adapters ([7944f1b](https://github.com/edwardlthompson/JanusBoot/commit/7944f1b2a76322c5b96dc666922fa0c88d0ce628))
* add privacy-first GitHub crash and feedback intake ([0f5f29b](https://github.com/edwardlthompson/JanusBoot/commit/0f5f29b469257e1e939a4f789bfe9fc36782dac6))
* **agent:** add prior-art thin steals and clear High Dependabot ([80dc2a6](https://github.com/edwardlthompson/JanusBoot/commit/80dc2a60caab73a9b1c097e97a5ee9dce4d54c20))
* **agents:** automate BUILD_PLAN human gates and Sprint M8 CI ([810e259](https://github.com/edwardlthompson/JanusBoot/commit/810e259ceb69994800372d2f66df09c918465738))
* **agents:** autonomous /build with HUMAN/ADB automation ([cdea429](https://github.com/edwardlthompson/JanusBoot/commit/cdea429beecea4c9cf2e099d4fbea7b4e873f9f7))
* **agents:** execute Sprint M13 human-gate automation ([4fddec8](https://github.com/edwardlthompson/JanusBoot/commit/4fddec8aa677ab5f873a86e88dbb56bb5082bc46))
* **agents:** execute Sprint M14 post-M13 review remediation ([fc71433](https://github.com/edwardlthompson/JanusBoot/commit/fc71433fcbfeae3c15703adedde7970106c80c90))
* **agents:** execute Sprint M15 P2 backlog and archive M14 ([a5f3199](https://github.com/edwardlthompson/JanusBoot/commit/a5f3199255d5f897aa960da92cdcf6b09c0579df))
* **agents:** execute Sprint M9 sequential rows 1-7 ([e8e6831](https://github.com/edwardlthompson/JanusBoot/commit/e8e6831f3367f41fce5cb22f25c7d07347034e98))
* **agents:** execute Sprint M9-8 and M10 code review remediation ([9163dab](https://github.com/edwardlthompson/JanusBoot/commit/9163dab255d4a7552ea1d0d4f169f2b78f569593))
* **agents:** finish Sprint M15 instrumented CI and SBOM release wiring ([4d5993d](https://github.com/edwardlthompson/JanusBoot/commit/4d5993df6602186f479de0fff0b2395ecb5860c3))
* **agents:** incremental feature assembly and autonomous agent gates ([3d47485](https://github.com/edwardlthompson/JanusBoot/commit/3d4748595589a642db0373947ae2152e5e3cd1de))
* **agents:** parallel-first BUILD_PLAN and auto multi-agent dispatch ([f0a0b2f](https://github.com/edwardlthompson/JanusBoot/commit/f0a0b2fd0b93aa3a6aebdf38992c0337265cd7a2))
* **android:** add cmdline-tools install without auto-license ([67d12a9](https://github.com/edwardlthompson/JanusBoot/commit/67d12a98a4208b3da46cf0a31ab79f9dc20be8e4))
* **android:** add F-Droid device dry-run scripts (M28) ([fb90878](https://github.com/edwardlthompson/JanusBoot/commit/fb9087846d424b088d37ed4e77ee13c672e9c0b6))
* **android:** add system bar insets and 3-button nav compensation ([cc946af](https://github.com/edwardlthompson/JanusBoot/commit/cc946af6eb590db574815de69e2ad955e993b250))
* **android:** fail dummy F-Droid store screenshots ([96a9a2e](https://github.com/edwardlthompson/JanusBoot/commit/96a9a2e1f464aa82c4688e884f5da186f3291a7c))
* **android:** turn on release R8 and Android 17 memory hooks ([#95](https://github.com/edwardlthompson/JanusBoot/issues/95)) ([eeb783e](https://github.com/edwardlthompson/JanusBoot/commit/eeb783e63cdffeb7e0f5b3c7d949a92d9a10fb4f))
* **android:** use Gradle --offline after first worktree ([9197d44](https://github.com/edwardlthompson/JanusBoot/commit/9197d441abbfdd702c257d928a10d16f07ad7786))
* **bootstrap:** lock product brief and add Cycles icon factory ([7194eb0](https://github.com/edwardlthompson/JanusBoot/commit/7194eb0f905cb649a2729192742887f5ada2d8f7))
* **branding:** add branding kit and pitch README generator ([2488b09](https://github.com/edwardlthompson/JanusBoot/commit/2488b0962f0921e855c0c5afe6ed5af15a1337a1))
* **branding:** drive OG social preview from design tokens ([c25f702](https://github.com/edwardlthompson/JanusBoot/commit/c25f702985150dc1faaf90a5cc072b87c7001a4a))
* **build:** automate leftover HUMAN rows that scripts can close ([1fb50e8](https://github.com/edwardlthompson/JanusBoot/commit/1fb50e8ac20b058505f09c4464368d07c3ea6675))
* **build:** sync Monday template gaps into BUILD_PLAN ([1b528f4](https://github.com/edwardlthompson/JanusBoot/commit/1b528f483f7206c4acaf2eb19921e009ef91e96b))
* **build:** sync open PRs into BUILD_PLAN and add /resume handoff ([868d655](https://github.com/edwardlthompson/JanusBoot/commit/868d6556ee26b96e830150e5dcb68f3c3cddd549))
* **ci:** skip Playwright --with-deps on lockfile cache-hit ([85105cc](https://github.com/edwardlthompson/JanusBoot/commit/85105cc2180cd1bfc9a1b6816db8fcca0e8c9208))
* **cloud:** add JanusBoot vision, schemas, and ESP fixtures ([03b6955](https://github.com/edwardlthompson/JanusBoot/commit/03b695554151f95b1bdad083e7feb0ad1888b37e))
* **cloud:** replace hello with janusbootctl CLI ([d6255e1](https://github.com/edwardlthompson/JanusBoot/commit/d6255e198c2a8a383456a4d1a090f732ea4cd7e6))
* **commands:** add /adr for the next docs/adr record ([51116a7](https://github.com/edwardlthompson/JanusBoot/commit/51116a7ab63cd83fc422411d7c379fa263a29d53))
* **commands:** add /cleanup to archive BUILD_PLAN rows after build ([d7ab7fc](https://github.com/edwardlthompson/JanusBoot/commit/d7ab7fc96d411be36ead3f1d31dc433041c30bb2))
* **commands:** add batch instruction templates (M27) ([4fe713a](https://github.com/edwardlthompson/JanusBoot/commit/4fe713a51335c576058fc0e435bd419a272e8b8e))
* **cursor:** integrate 3.9-3.11 surfaces and local-first compute ([5d2d129](https://github.com/edwardlthompson/JanusBoot/commit/5d2d12920f68dc23e02071cfe2e43f04bd924f31))
* **cursor:** integrate FOSS hooks, skills, subagents, and feature radar (M30) ([1cd2b72](https://github.com/edwardlthompson/JanusBoot/commit/1cd2b726e8ac6a63cadfa5e63851e935fe1f53ac))
* **cursor:** quiet agent shell with Python hooks and agent-run ([7fc8e4b](https://github.com/edwardlthompson/JanusBoot/commit/7fc8e4b455655acb68c5037e364ada7454177d01))
* **deps:** apply depsonar Gradle pins with Kotlin cap ([cd10282](https://github.com/edwardlthompson/JanusBoot/commit/cd10282b13c4668ad641d690f28f78cee2fecf46))
* **deps:** render update-deps dry-run as a canvas ([443a320](https://github.com/edwardlthompson/JanusBoot/commit/443a320371897050985b87e41743614c907adf68))
* design system, web layout docs, and Golden Path UI refresh ([912ebbe](https://github.com/edwardlthompson/JanusBoot/commit/912ebbe2c57fb2d47223c49b3332f3037cc9c80f))
* **docs:** add Cursor mode routing and repo sanity gates (M19-M25) ([9782e75](https://github.com/edwardlthompson/JanusBoot/commit/9782e757d95d06a27b1d03db27faf2a978e3c9c9))
* **docs:** add mermaid flowchart to generated README ([2d667b8](https://github.com/edwardlthompson/JanusBoot/commit/2d667b80a5bd2691664b31da6a7a02458976b36d))
* **docs:** add README badge accuracy gate ([426c3c6](https://github.com/edwardlthompson/JanusBoot/commit/426c3c6a2a6b1e40b0fe6b3bf0a15475dadabefe))
* **docs:** keep FIRST_30_DAYS aligned with health JSON ([f93a8e2](https://github.com/edwardlthompson/JanusBoot/commit/f93a8e28f6d5eb9b502614e6f3eabc4ee5ba7886))
* **gates:** add per-stack feature-gate command timeouts ([bb34985](https://github.com/edwardlthompson/JanusBoot/commit/bb3498571a48008f7ec7f12c2d4aa39a1c25143e))
* **github:** add /ideas Discussion template ([b8e971e](https://github.com/edwardlthompson/JanusBoot/commit/b8e971e7616d0c05e76a9b1184f2b880f32cc0cb))
* **github:** add Sacred/Canon/Mixed upgrade issue form ([c340585](https://github.com/edwardlthompson/JanusBoot/commit/c340585e56ca747f26c729999ba540158ffbd2bb))
* **github:** add settings.yml desired-state for branch protection ([eb04760](https://github.com/edwardlthompson/JanusBoot/commit/eb047605f4d7c61d0a4c9c257c7033aacc35f42c))
* **github:** use a required-check name manifest ([35f9735](https://github.com/edwardlthompson/JanusBoot/commit/35f9735b89027bd83bdbded19be0a40821781b5c))
* harden Windows PATH, Unreleased fold, and ship gates ([8eab392](https://github.com/edwardlthompson/JanusBoot/commit/8eab392edff967bbc0cfabb89aff0902a6b8ac0e))
* **hooks:** allowlist FOSS MCP servers before execution ([673e128](https://github.com/edwardlthompson/JanusBoot/commit/673e128a688450a2c620ea7044fdf3f13c851aa5))
* initial agent-project-bootstrap template v0.1.0 ([d71c23c](https://github.com/edwardlthompson/JanusBoot/commit/d71c23c22dd97b96f3ef91435319d5df04bb28b6))
* land M46 Golden Path slices, agent UX, and offline CI linters ([a730fa3](https://github.com/edwardlthompson/JanusBoot/commit/a730fa308f0d283ba74fc12de325b340231a5ca6))
* **limits:** adopt static data 300L and pure logic 150L taxonomy ([49c7407](https://github.com/edwardlthompson/JanusBoot/commit/49c740719cfe8eb760a7d3cb4e675769cb296d27))
* **local:** add QEMU Makefile and host docs for Phase 0-2 ([aeb8959](https://github.com/edwardlthompson/JanusBoot/commit/aeb8959afdbb0818d5c45eed8a64bafa435fc646))
* **local:** automate host deps, qemu-smoke, and product remote ([9e58182](https://github.com/edwardlthompson/JanusBoot/commit/9e5818269c5c1962b74d8b8037c664be750c8d3a))
* **local:** land qemu-smoke host path and Phase 0-2 board closeout ([d809837](https://github.com/edwardlthompson/JanusBoot/commit/d80983799f97a1e7902d9b2f79007973d8fe2442))
* **m16-p2:** prune-optional smoke, a11y, i18n test fix, lightroom prune ([0212a19](https://github.com/edwardlthompson/JanusBoot/commit/0212a194012e884490e44d1f0194ed48756e9754))
* **m18-p2:** complete post-sequential backlog — tests, gates, CI, SW cache ([d2e088d](https://github.com/edwardlthompson/JanusBoot/commit/d2e088de9d7f97813a0ca66d4c4b3335455bf853))
* **m18:** remediate post-P2 review — Pages base path, Android apply, init config ([9105ebb](https://github.com/edwardlthompson/JanusBoot/commit/9105ebb129e660c288c65f6bef3ee7a67aeec4dd))
* **nav:** Cline first-run + Golden Path route stack model ([#85](https://github.com/edwardlthompson/JanusBoot/issues/85)) ([4734a35](https://github.com/edwardlthompson/JanusBoot/commit/4734a35894870afdea580965be257035e23a2b6b))
* **nix:** add optional flake that only wraps existing scripts ([d37cd41](https://github.com/edwardlthompson/JanusBoot/commit/d37cd41d5f744a241159551fa66cc36eb1005349))
* **p2:** complete M17 P2 backlog — a11y, updates, CI, docs ([64ec578](https://github.com/edwardlthompson/JanusBoot/commit/64ec578a352d6d771c8d774d68da93f0fd01467d))
* **pages:** fail /regress when the web tree has analytics ([448130f](https://github.com/edwardlthompson/JanusBoot/commit/448130f5ce2342b239e2ef60da1536a44325d3e6))
* **python:** About+crash beside janusbootctl; waive Sacred UPG-71..77 ([a337d62](https://github.com/edwardlthompson/JanusBoot/commit/a337d625ab0f05c77ee6ab7b3bd8875daedb00ec))
* **python:** enforce pytest in CI and workflow gates ([ec3939f](https://github.com/edwardlthompson/JanusBoot/commit/ec3939f8569f95083643e20fba8970b13e0e180a))
* **quality:** Codex review, multi-stack autofix, expanded /prerelease ([13cbb5d](https://github.com/edwardlthompson/JanusBoot/commit/13cbb5d5d4c1bbb84f08032bc692d292869e4485))
* **release:** auto-merge Release Please PRs via workflow and script ([0e817c3](https://github.com/edwardlthompson/JanusBoot/commit/0e817c370bc44a01320815ee9cd266573b99b507))
* **release:** bump plugin.json version via Release Please ([49f02cb](https://github.com/edwardlthompson/JanusBoot/commit/49f02cb4d952108f8ced3130542d3d2f91937579))
* **release:** require empty Unreleased before /push ([5e3a778](https://github.com/edwardlthompson/JanusBoot/commit/5e3a778a709b96242b7b1e6b4c3832ef3b31ec5d))
* request fastest same-resolution display mode on Android ([90428a6](https://github.com/edwardlthompson/JanusBoot/commit/90428a64f24aa89409a287fca5b9e1ea1b030961))
* **security:** add Auto-review allow/block fixtures ([22ddeb1](https://github.com/edwardlthompson/JanusBoot/commit/22ddeb11403884f7bcce17ef88a8a9cc31b431e3))
* **security:** add FOSS Semgrep rules without SaaS upload ([43a09be](https://github.com/edwardlthompson/JanusBoot/commit/43a09be567d867c57eb8761e62809367834f182d))
* **security:** add Gitleaks baseline for fixture secrets ([ad9f7b5](https://github.com/edwardlthompson/JanusBoot/commit/ad9f7b5621d12db11a7e7a95849155426ef6db0a))
* **security:** redact prompt-injection phrases in crash text ([4be4cff](https://github.com/edwardlthompson/JanusBoot/commit/4be4cff05cd2fb8c57e3aeb09a488454f8264718))
* template v0.2.0 with UTF-8 gates, lockfiles, and build verification ([2317440](https://github.com/edwardlthompson/JanusBoot/commit/2317440eeecec0ef961bb9cf54ea3830c183d8cf))
* **ui:** Settings-only chrome and glanceable menus ([#96](https://github.com/edwardlthompson/JanusBoot/issues/96)) ([a8ce80b](https://github.com/edwardlthompson/JanusBoot/commit/a8ce80b0c316cf604fa2cde31bcb71f933904b42))
* **ux:** add construction law and /ux-review inventory ([f532e8b](https://github.com/edwardlthompson/JanusBoot/commit/f532e8bf486d8997a424ef90d9cbcc65208bb794))


### Fixed

* add gradle.properties with android.useAndroidX for assembleDebug ([ea87f7d](https://github.com/edwardlthompson/JanusBoot/commit/ea87f7dfd40500a7550759fb4466418de5ed2aae))
* **agents:** execute Sprint M11 post-M10 hardening ([daa9d85](https://github.com/edwardlthompson/JanusBoot/commit/daa9d858afe0eed78e95913107af704e652fb964))
* **agents:** execute Sprint M12 post-M11 polish ([0f859fd](https://github.com/edwardlthompson/JanusBoot/commit/0f859fd5211e06d06647760cccde452402254614))
* **agents:** use auto lane for autonomous /build ([f460ee0](https://github.com/edwardlthompson/JanusBoot/commit/f460ee0796f540beb271ae65ca81f045e1bbb8a3))
* Android CI — google maven for AGP and FOSS grep comment false positive ([b907c46](https://github.com/edwardlthompson/JanusBoot/commit/b907c46628f05275ecefb149bc230ea08ac47845))
* **android:** ApkDownloadHelperTest uses file-as-parent path on Unix CI ([be237e7](https://github.com/edwardlthompson/JanusBoot/commit/be237e7d99778624ca3fe0c3a9b54ef8db74a856))
* **android:** apply preferred display mode after the window attaches ([c205177](https://github.com/edwardlthompson/JanusBoot/commit/c20517794b21adc105170cd7bfbf7807c6f611a5))
* **android:** bump compileSdk to 37 for androidx 1.19 dependencies ([3a74f0c](https://github.com/edwardlthompson/JanusBoot/commit/3a74f0c08d32aff7a14d6fb7eff829578cbe73da))
* **android:** Espresso 3.7 for Android 16 + nav Back smoke ([ca0edfb](https://github.com/edwardlthompson/JanusBoot/commit/ca0edfb56b0073628111601e1cfc0449aa0378e0))
* **android:** keep Venmo donate under Settings → About ([#90](https://github.com/edwardlthompson/JanusBoot/issues/90)) ([9cfa1e8](https://github.com/edwardlthompson/JanusBoot/commit/9cfa1e819acd11a9ba9956a82a1d5edb65d509a5))
* **android:** migrate Golden Path example to AGP 9 built-in Kotlin ([a84a16c](https://github.com/edwardlthompson/JanusBoot/commit/a84a16c8fa7e67d3179b820962aead03add7be34))
* **android:** pin androidx.test runner/rules to published 1.6.1 ([5195c46](https://github.com/edwardlthompson/JanusBoot/commit/5195c463cbb219d490915a901bf350687b2dd98d))
* **android:** pin Kotlin compose plugin 2.3.20 for CodeQL ([7055255](https://github.com/edwardlthompson/JanusBoot/commit/70552559df7dd57d8f9ad7d2ee334ee4f6759c04))
* **android:** read INTERNET permission from PackageInfo in test ([5d9be3e](https://github.com/edwardlthompson/JanusBoot/commit/5d9be3e9f3144468f84e2bdca0121788582e930c))
* **android:** rewrite Gradle Kotlin DSL files as UTF-8 ([11bc782](https://github.com/edwardlthompson/JanusBoot/commit/11bc78233b804ccaaca318f630f9eb1501cf10b8))
* **android:** Robolectric-safe UpdateApplierTest on Windows ([38635a3](https://github.com/edwardlthompson/JanusBoot/commit/38635a3d7948d0e592833c63612a76c3069b4314))
* **android:** stop instrumented CI fails from Assume and brittle asserts ([c05c71e](https://github.com/edwardlthompson/JanusBoot/commit/c05c71e01f4b05a3b98383315b32e3366c82d434))
* **android:** test UpdateApplier intent build without startActivity ([27259c6](https://github.com/edwardlthompson/JanusBoot/commit/27259c65261fc44eac696565d01022e6f49c5ccd))
* **android:** write test APK under FileProvider cache-path ([f59023c](https://github.com/edwardlthompson/JanusBoot/commit/f59023cc342d456a653d27643a250ce9957b6abf))
* bind vite preview to 127.0.0.1 for Playwright CI and extend pre-commit encoding ([9a3f935](https://github.com/edwardlthompson/JanusBoot/commit/9a3f9357ab4ca2d2afcdf8250ce955a6f46e9c60))
* **changelog:** keep a single Unreleased section ([dcbea94](https://github.com/edwardlthompson/JanusBoot/commit/dcbea948a8cd0f3b49891bb1add66aa796906808))
* **changelog:** remove duplicate Unreleased section for CI gate ([4c82890](https://github.com/edwardlthompson/JanusBoot/commit/4c8289072c7db231063be65e2a263be05f4af0bc))
* **ci:** clear remaining v1.3.0 gate failures ([ae2775f](https://github.com/edwardlthompson/JanusBoot/commit/ae2775f689b226896dbe4e8dbf9d88c38110232b))
* **ci:** declare CodeQL workflow permissions for zizmor ([74cf63e](https://github.com/edwardlthompson/JanusBoot/commit/74cf63e0a717346089a330657c5ec4a3cdd543a1))
* **ci:** do not treat shellcheck prose as a directive ([52688b4](https://github.com/edwardlthompson/JanusBoot/commit/52688b4265dfbbbb2cc1f2a157ad7d6ef6933572))
* **ci:** gofmt Go example and harden PR coverage comment parsing ([0423990](https://github.com/edwardlthompson/JanusBoot/commit/0423990b4ece9559a42db6c6bc66cec0eab518c8))
* **ci:** green Feature Gate, a11y, upgrade sim, and zizmor ([fb75a80](https://github.com/edwardlthompson/JanusBoot/commit/fb75a806d8dad2d77117d2a300414b03684ec076))
* **ci:** heal Dependabot merge CI gap and automate M32 human gates ([4d195a2](https://github.com/edwardlthompson/JanusBoot/commit/4d195a2ed8944610fbdb011313f2fd9692c7445c))
* **ci:** index release automerge paths; correct bypass docs ([5d4682d](https://github.com/edwardlthompson/JanusBoot/commit/5d4682d0ab6307005a584761534233d212104e2b))
* **ci:** index setup-automerge-token in TEMPLATE_INDEX ([e532c20](https://github.com/edwardlthompson/JanusBoot/commit/e532c209a03e562db051588af2e1fc0193381850))
* **ci:** isolate commit-msg hook test from upgrade-sim env ([1973533](https://github.com/edwardlthompson/JanusBoot/commit/1973533d82e8bfa94bc15b8d334365bc5cd7b18b))
* **ci:** move optional job existence checks into path-changes job ([f7213ec](https://github.com/edwardlthompson/JanusBoot/commit/f7213eca78069907a08f181de996f516f9fa5341))
* **ci:** pass actionlint shellcheck and upgrade-sim hook gate ([2e1ede3](https://github.com/edwardlthompson/JanusBoot/commit/2e1ede38a2a05755f5426bdf0e9e29dc0f65d3df))
* **ci:** pin Kotlin for CodeQL and repair weekly health workflow ([66d58f6](https://github.com/edwardlthompson/JanusBoot/commit/66d58f62767adc51b4b10c749d324baf1b2509e0))
* **ci:** publish CI and Security Scan required check names ([79b875c](https://github.com/edwardlthompson/JanusBoot/commit/79b875cbf64962675e07bc1e206bdf101f3fe66a))
* **ci:** quote upgrade-sim skip steps for valid YAML ([06e9582](https://github.com/edwardlthompson/JanusBoot/commit/06e9582c2aaba3b27019c0318a4022d31abaab64))
* **ci:** re-pin Kotlin 2.3.20 for CodeQL after Dependabot [#26](https://github.com/edwardlthompson/JanusBoot/issues/26) ([42f4659](https://github.com/edwardlthompson/JanusBoot/commit/42f4659d373b8bd07172c6d091ebf02b6bebfb11))
* **ci:** remove job-level hashFiles guards from ci.yml ([36fdbc1](https://github.com/edwardlthompson/JanusBoot/commit/36fdbc118f25e5865fb18aee653728ee87613f09))
* **ci:** repair corrupted template literals in coverage comment job ([a64ad04](https://github.com/edwardlthompson/JanusBoot/commit/a64ad04b1fd5ec301110925d8783ed8a1653a6ab))
* **ci:** repair M12 gate failures (TS tests, Kotlin pin) ([cb1c5d5](https://github.com/edwardlthompson/JanusBoot/commit/cb1c5d5a51793daa0377c9f82ea84affc7b9d222))
* **ci:** repair workflow action SHAs, e2e selectors, and shell line endings ([38ce003](https://github.com/edwardlthompson/JanusBoot/commit/38ce003771c04cdc043ffc79bf8ee2296fac19aa))
* **ci:** run android instrumented gradle in single shell script ([976a87f](https://github.com/edwardlthompson/JanusBoot/commit/976a87ffda747d952a024f82623d8622cbce89dd))
* **ci:** scope design cohesion checks to active example stacks ([5130309](https://github.com/edwardlthompson/JanusBoot/commit/513030942117f1b3f93f8402ed40e12e1c2ae095))
* **ci:** Settings→About e2e + Android donate UI test compile ([#92](https://github.com/edwardlthompson/JanusBoot/issues/92)) ([4e2dc1c](https://github.com/edwardlthompson/JanusBoot/commit/4e2dc1c107e23f6bb06a489f48103d8c683d9564))
* **ci:** skip blender icon tests when the example is pruned ([1ac1e66](https://github.com/edwardlthompson/JanusBoot/commit/1ac1e66ac72ec7dfa61de0a2d2de70c70857d108))
* **ci:** skip go-missing gate test when go example pruned ([0805ffe](https://github.com/edwardlthompson/JanusBoot/commit/0805ffea511e31b444f22a33386ef1177f7a4ad6))
* **ci:** skip obsolete Android SDK tools package ([edf6009](https://github.com/edwardlthompson/JanusBoot/commit/edf600916f2bda44fffcebca0512f4ff8fded9d9))
* **ci:** skip pruned stacks on python-only child repos ([937f0fe](https://github.com/edwardlthompson/JanusBoot/commit/937f0feceb9d6a02051bdd34f1f6a5f9820f35dd))
* **ci:** skip stack-specific bootstrap checks after prune ([3e66933](https://github.com/edwardlthompson/JanusBoot/commit/3e669333b7cfc929b66293b3fea7fd4c79c16fb4))
* **ci:** stabilize PWA apply e2e and about-feature-gate for appBootstrap ([8946089](https://github.com/edwardlthompson/JanusBoot/commit/8946089ed2c265c1a5e4cd7996dea328b1a8c6e5))
* **ci:** TBT lighthouse floor and skip flaky Android recreates on CI ([d73e9a9](https://github.com/edwardlthompson/JanusBoot/commit/d73e9a9fa102007ca1a6506490397b83f5f9dd9e))
* **ci:** unblock Semgrep, actionlint, and upgrade-sim ([7543909](https://github.com/edwardlthompson/JanusBoot/commit/754390994b591176a38a70e642e6e309c3035272))
* **ci:** use full git history for Gitleaks on Release Please PRs ([01d585b](https://github.com/edwardlthompson/JanusBoot/commit/01d585bcc1183633139cf46d4ca4932c3dbd8ee3))
* **ci:** use stack-presence job for conditional Python matrix ([ce6bfb3](https://github.com/edwardlthompson/JanusBoot/commit/ce6bfb3aa839fff8b75088e1c98f874ded2d89de))
* correct gh api calls in validate-workflow-actions.sh ([100df56](https://github.com/edwardlthompson/JanusBoot/commit/100df5649aee5724b22a70c84742453a106f1f1a))
* **cursor:** harden hook validation and complete M31 audit ([cd21e5a](https://github.com/edwardlthompson/JanusBoot/commit/cd21e5a70e8d2848bcbdf9d22b1e62daccff55c1))
* **deps:** cap undici override at 7.x for jsdom compat ([24b240f](https://github.com/edwardlthompson/JanusBoot/commit/24b240f325b6b42363f638a2067c8a005b7c798a))
* **deps:** override transitive tmp and uuid for @lhci/cli alerts ([222fb59](https://github.com/edwardlthompson/JanusBoot/commit/222fb59f5aa2d11b66c79496c23ad0980108b620))
* **deps:** override undici to close Dependabot CVE alerts ([e1e9790](https://github.com/edwardlthompson/JanusBoot/commit/e1e9790c16fd0c95cbf25d056d9c6f8bff59cf61))
* **docs:** index cursor-modes rule and align START_HERE paths (M26) ([8bbf689](https://github.com/edwardlthompson/JanusBoot/commit/8bbf68973260799ff6292416509590e37991246d))
* **docs:** index template version sync scripts in TEMPLATE_INDEX ([367b650](https://github.com/edwardlthompson/JanusBoot/commit/367b650a1cd490f3ca181c42aaa4fe79020278cf))
* **e2e:** stabilize PWA apply test — assert button visibility only ([bda25d2](https://github.com/edwardlthompson/JanusBoot/commit/bda25d25cfed80f16ad7835df56c68a5eac4e458))
* extend encoding scan to Android kts/kt/xml/properties ([8f52c55](https://github.com/edwardlthompson/JanusBoot/commit/8f52c550f52231520c76dd0a12326c0838db07e4))
* ignore pruned stack links in the docs gate ([d7a3ba0](https://github.com/edwardlthompson/JanusBoot/commit/d7a3ba099736f2194e08ec5d4d75ae6c4704935c))
* import rp_merge_status from cwd-relative scripts/lib ([df322af](https://github.com/edwardlthompson/JanusBoot/commit/df322af79d3302457f6dad26fac0d2e424544a15))
* improve CI configs for python packaging and vitest ([36fbb39](https://github.com/edwardlthompson/JanusBoot/commit/36fbb394c5c1aa414c812334aa8628abfc47f178))
* index privacy-feedback scripts and workflows ([c29987e](https://github.com/edwardlthompson/JanusBoot/commit/c29987e475a680dceb4e09b38dd125b730bc6d27))
* **init:** skip design-token sync for pruned example stacks ([1844483](https://github.com/edwardlthompson/JanusBoot/commit/184448395220b7dc104dcf85c81b8f1f3e313bba))
* keep portable-purpose test valid after child init stamp ([5084b4b](https://github.com/edwardlthompson/JanusBoot/commit/5084b4b07542c583371e2e4e0277ac81731f42c1))
* **m16:** tag-gate jobs-only poll, SBOM version assert, CI parity ([3f071cb](https://github.com/edwardlthompson/JanusBoot/commit/3f071cb9608910cb765ba5b465b3dfa6743df3dc))
* **m17:** INTERNET permission, update timing, prune index, release CI gate ([96829ae](https://github.com/edwardlthompson/JanusBoot/commit/96829aea0af3ff24a6942a9add8f9fb4c2e2364f))
* normalize Android example UTF-16 files for Gradle CI ([39a78d3](https://github.com/edwardlthompson/JanusBoot/commit/39a78d36844739a9b5b77cb1f9876feb229accca))
* normalize UTF-16 index.html and extend encoding scan to html/css ([e16272e](https://github.com/edwardlthompson/JanusBoot/commit/e16272eded9901380c086dad4da6189e548209f4))
* playwright preview server host and timeout for CI e2e ([99188fa](https://github.com/edwardlthompson/JanusBoot/commit/99188faff52638196366aa8f967cfa832900e37e))
* **release:** automate version sync and SBOM dispatch (M29) ([8b7d62e](https://github.com/edwardlthompson/JanusBoot/commit/8b7d62ecbe5ee0fa4d1572fd870495bf51936460))
* **release:** guard empty release-please pr output on merge push ([1d1b56c](https://github.com/edwardlthompson/JanusBoot/commit/1d1b56c3010a7e048e9ca4fe197eb2b284d3df26))
* **release:** parse Release Please PR number from JSON output ([57201aa](https://github.com/edwardlthompson/JanusBoot/commit/57201aa03595979196dff79c5c0327e7e70f4725))
* **release:** SBOM backfill from main; add template version sync gate ([d3b4c05](https://github.com/edwardlthompson/JanusBoot/commit/d3b4c057db7470593244f46ed5d3dc9c04468a99))
* **release:** skip pre-release gate for SBOM backfill dispatch ([ac1377c](https://github.com/edwardlthompson/JanusBoot/commit/ac1377c15840f428c6ec36095a4f7ac820d4f88b))
* repair Security Scan workflow and add GH CI automation ([80f9fc0](https://github.com/edwardlthompson/JanusBoot/commit/80f9fc03a5ada9ef795b39111d2de6b508a982c6))
* resolve CI failures in web lint, python format, and android grep ([444ad7b](https://github.com/edwardlthompson/JanusBoot/commit/444ad7b4c713257bb749371c7c9882b0e883bd19))
* **scripts:** stub settings preferences when verifying About removal ([d6b92a2](https://github.com/edwardlthompson/JanusBoot/commit/d6b92a2c31c464bdd6595dcd49adf7fe305020e1))
* **security:** clear Dependabot npm High/Moderate alerts ([647e4ed](https://github.com/edwardlthompson/JanusBoot/commit/647e4ede6fecfcd4278e3cb5b4708fdd9b621069))
* **security:** clear High npm alerts and harden plan critiques ([2b119a7](https://github.com/edwardlthompson/JanusBoot/commit/2b119a78f088f91077ff96f3657c622bc9755395))
* **security:** override postcss &gt;=8.5.18 in examples/node ([981ee64](https://github.com/edwardlthompson/JanusBoot/commit/981ee64ae64560394f4cb8e0614ab6589610e60b))
* stabilize Lighthouse CI with 3-run median ([f41c48d](https://github.com/edwardlthompson/JanusBoot/commit/f41c48daff6d8a148d86ba5cfabf800d015c806d))
* strip CR from jq paths in template-index gate ([812a2db](https://github.com/edwardlthompson/JanusBoot/commit/812a2db71bca3929334d913848826bedffb4d80f))
* sync template version files to 0.11.0 for release PR ([5fe0fc1](https://github.com/edwardlthompson/JanusBoot/commit/5fe0fc1f0359238f9884b32c519496ba9d59e990))
* treat OWNER/REPO placeholder as unset for update checks ([2721c01](https://github.com/edwardlthompson/JanusBoot/commit/2721c01d0cf4adb36ecf123aeb42c0c6429a5e80))
* **upgrade-sim:** skip full bootstrap validation after prune pass ([1634917](https://github.com/edwardlthompson/JanusBoot/commit/1634917f35ee9137ffb56b5c3a6e763025819ed7))
* **web:** assign narrowed HTMLDivElement for AppShell root ([f1dad83](https://github.com/edwardlthompson/JanusBoot/commit/f1dad832e03f2adda807a99fadc63e314d0d833c))
* **web:** do not re-seed donate nudge prefs on reload ([6ab382c](https://github.com/edwardlthompson/JanusBoot/commit/6ab382c288dbec31a0eef5fcd43d93f49d511719))
* **web:** lock proxy-agent 8 so npm ci matches browsers override ([be4333b](https://github.com/edwardlthompson/JanusBoot/commit/be4333baa5dcf65044d03bc365aead8b939172e6))
* **web:** narrow app root type for AppShell render ([53406b1](https://github.com/edwardlthompson/JanusBoot/commit/53406b1b84736d145ebf620a5852a6d6eb23c087))
* **web:** override js-yaml to patch Dependabot alert [#9](https://github.com/edwardlthompson/JanusBoot/issues/9) ([609165c](https://github.com/edwardlthompson/JanusBoot/commit/609165c6321cb2498c39541b5315ff19a533f7fb))
* **web:** resolve CI lint and file-size budget failures ([1759a8f](https://github.com/edwardlthompson/JanusBoot/commit/1759a8f54b80f54564318e4174f56388d20047ef))
* **web:** use hasAttribute for disabled check in panelDialog ([f4d082e](https://github.com/edwardlthompson/JanusBoot/commit/f4d082ea1331446f45baeabd77f55818ec5a8cdf))
...
* **ux:** add construction law and /ux-review inventory ([f532e8b](https://github.com/edwardlthompson/agent-project-bootstrap/commit/f532e8bf486d8997a424ef90d9cbcc65208bb794))


### Fixed

* **ci:** skip obsolete Android SDK tools package ([edf6009](https://github.com/edwardlthompson/agent-project-bootstrap/commit/edf600916f2bda44fffcebca0512f4ff8fded9d9))
...
* **ci:** skip blender icon tests when the example is pruned ([1ac1e66](https://github.com/edwardlthompson/agent-project-bootstrap/commit/1ac1e66ac72ec7dfa61de0a2d2de70c70857d108))
* **ci:** skip go-missing gate test when go example pruned ([0805ffe](https://github.com/edwardlthompson/agent-project-bootstrap/commit/0805ffea511e31b444f22a33386ef1177f7a4ad6))
...
* **release:** archive v0.24.0 ship memory and decisions ([de1c6d0](https://github.com/edwardlthompson/agent-project-bootstrap/commit/de1c6d0ad57237a3b9f62e97f517912fc01bf72a))
...
* **release:** archive v0.21.0 ship memory and decisions ([55fd2b8](https://github.com/edwardlthompson/agent-project-bootstrap/commit/55fd2b8b8efc0b34bdd332d5bd60f6e2743e9188))
...
* **deps-dev:** Bump the web-dependencies group across 1 directory with 5 updates ([40f1ff8](https://github.com/edwardlthompson/agent-project-bootstrap/commit/40f1ff879ec039beeff60e666e6c0ced5d582705))
