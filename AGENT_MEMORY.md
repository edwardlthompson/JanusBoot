...
| 2026-09-17 | v1.1.0 /ship | Cleanup #37; deps patch/minor; RP #2 → tag v1.1.0; CI unittest+TEMPLATE_INDEX fix; local/phase-0-2 ff | HUMAN: ESP/NVRAM, Windows elevation UX, ISO #38; confirm Scorecard+Release SBOM after Actions registry nudge |
